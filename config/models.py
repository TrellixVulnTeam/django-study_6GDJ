...
class  SideBar(models.Model):
    ...
    title = models.CharField(max_length=50,verbose_name="标题")
    display_type = models.PositiveIntegerField(default=1,choices=SIDE_TYPE,verbose_name="展示类型")  #PositiveIntegerField只包含正整数。
    ...
    def content_html(self):
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            result = render_to_string('config/blocks/sidebor_comments.html',context)
        return result
